<div>
    @if (session()->has('error') || $errors->any())
        <div class="fixed top-6 right-8 z-50 max-w-lg w-full px-4">
            <div class="bg-red-600/80 text-white rounded-xl shadow-lg backdrop-blur-md border border-red-400/50 px-6 py-4 flex items-center space-x-3 animate-fade-in">
    ...
    <div class="login-card rounded-2xl overflow-hidden shadow-2xl">
        <div class="flex flex-col md:flex-row">
            ...
            <div class="md:w-1/2 relative">
                <img src="{{ asset('img/card login.jpeg') }}" alt="Pemandangan Magetan" class="w-full h-full object-cover"
            ...
            <div class="md:w-1/2 flex items-center justify-center bg-black/60" style="border-top-right-radius:15px; border-bottom-right-radius:15px;">
                <div class="w-full flex flex-col items-center justify-center p-8">
                    <div class="mb-8 flex flex-col items-center justify-center">
                        <img src="{{ asset('img/LogoMagetan.png') }}" alt="Logo" style="width: 50px; height: 60px;">
