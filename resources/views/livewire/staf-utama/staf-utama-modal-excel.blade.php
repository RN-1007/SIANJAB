<div wire:ignore.self class="modal fade" id="modal-import-staf">
    <div class="modal-dialog">
        <div class="modal-content">
            <form wire:submit="importExcel" enctype="multipart/form-data">
                <div class="modal-header">
                    <h4 class="modal-title">Import Data Staf Utama</h4>
                ...
                <div class="modal-body">
                    <div class="form-group">
                        <label for="fileExcelStaf">Pilih File Excel</label>
                        <div class="input-group">
                            <div class="custom-file">
                                <input type="file" class="custom-file-input @error('fileExcel') is-invalid @enderror"
                                    id="fileExcelStaf" wire:model="fileExcel" accept=".xls,.xlsx">
                                <label class="custom-file-label" for="fileExcelStaf">
                                    @if ($fileExcel)
                ...
                <div class="modal-footer justify-content-between">
                    <div>
                        <a href="{{ asset('formats/format_import_staf_utama.xlsx') }}" target="_blank"
