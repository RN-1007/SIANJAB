        ...
        <div class="card">
            <div class="card-header">
                <h3 class="card-title font-weight-bold"><i class="fas fa-exclamation-triangle mr-2 text-warning"></i> Data
                    Uraian Tugas Staf Yang Belum Di Terima</h3>
                <div
                    style="
                                position: absolute;
                                bottom: 0;
                ...
                @else
                    <table id="example2" class="table table-bordered table-striped"
                        ...
                        <tbody>
                            @php
                                $tusiCounter = 0;
                                $subTugasCounter = 0; // Inisialisasi counter untuk sub-tugas
                                $previousTusiId = null;
                            @endphp
                            ...
                            @foreach ($dataUraianTugasValid as $item)
                                ...
                                <tr>
                                    @if ($currentTusiId != $previousTusiId)
                                        {{-- Jika Tusi baru, increment counter utama dan reset sub-counter --}}
                                        @php
                                            $tusiCounter++;
                                            $subTugasCounter = 1; // Reset counter sub-tugas menjadi 1
                                    ...
                                    @else
                                        {{-- Jika Tusi sama, increment sub-counter --}}
                                        @php
                                            $subTugasCounter++;
                                        @endphp
                                    ...
                                    <td>
                                        {{-- Tampilkan nomor bertingkat di depan uraian tugas --}}
